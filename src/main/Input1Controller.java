 ...
 */
public class Input1Controller implements Initializable {
    ...
    {
        if(number_of_unit.getText().length()>=1){
        managedButton();
        createTable();}
    }
    ...
    private void saveTable() throws IOException 
    {
        ...
        String st[]=new String[table.getItems().size()];
           ...
           BufferedWriter buffer =new BufferedWriter(new FileWriter(pathFinder()+"/src/main/FCFS.csv"));
